...
void main(void) {
    ...
    while (1)
    {
        ...
        case 5:
            ...
            do
            {
                ...
                if (option == 1) {
                    ...
                    arrangephysic(danhsachsinhvien);
                    cout << "          --------------------------" << endl;
                    cout << "          | DA SAP XEP THANH CONG! |" << endl;
                    cout << "          --------------------------" << endl;
                    cout << "            NHAP PHIM *0* DE THOAT :";
        ...
        case 7:
            ...
            saveToCSV(danhsachsinhvien, "danh sach sinh vien");
            cout << "--------------------------------------------------------------------------------" << endl;
